...
func (rc *RealtimeClient) EthGetBlockByTag(ctx context.Context, tag string) (map[string]interface{}, error) {
	var result map[string]interface{}
	err := rc.c.CallContext(ctx, &result, "eth_getBlockByNumber", tag, true)
	return result, err
}
