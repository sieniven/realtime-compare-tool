module github.com/sieniven/realtime-compare-tool

go 1.24.2

replace github.com/ledgerwatch/erigon => /Users/nivensie/dev/xlayer/xlayer-erigon/

replace github.com/ledgerwatch/erigon-lib => /Users/nivensie/dev/xlayer/xlayer-erigon/erigon-lib
